...
STREAM:[0,8,0,"Top1","","",1,1,"Level-1-arrow","Products","",0,'','',2,"Level-1-arrow","Support","",0,'','',0,"Level-1","Downloads","",0,'','',0,"Level-1","Tutorials","",0,'','',3,"Level-1-arrow","Purchase","",0,'','',0,"Level-1","Company","",0,'','',0,"Bottom1","","",1,1,7,0,"Heading","All Products","",1,0,"Level-2","Most Popular Products","",0,'','',0,"Level-2","LightBox","",0,'','',0,"Heading","Menu Collection","",1,0,"Level-2","Horizontal menu","",0,'','',0,"Level-2","Vertical menu","",0,'','',0,"Level-2","Accordion menu","",0,'','',2,7,0,"Level-2","Support Overview","",0,'','',0,"Level-2","Client Support","",0,'','',0,"Level-2","Client Center Home","",0,'','',0,"Level-2","Product Activation Keys","",0,'','',0,"Level-2","Download  Updates","",0,'','',0,"Level-2","Contact Priority Support","",0,'','',0,"Level-2","My Support History","",0,'','',3,6,0,"Level-2","Company store","",0,'','',0,"Level-2","Company store","",0,'','',0,"Level-2","Company store","",0,'','',0,"Level-2","Company store","",0,'','',0,"Level-2","Company store","",0,'','',0,"Level-2","Company store","",0,'',''],
END_PARAMETERS:1,
...
onload:function(){setTimeout('UYeefWB.start()',0)},
...
onmouseover:function(evt){var m=UYeefWB
...
m.updateDropdownsTimeLagged()}},
onmouseout:function(evt){var m=UYeefWB
m.cancelDropdownsUpdating()
var e=m.getSource(evt)
if(e)m.out(e)
else{m.lastFoid=0
...
m.updateDropdownsTimeLagged()},
onmouseup:function(evt){var m=UYeefWB
m.isdown=false
var e=m.getSource(evt)
if(e)m.clicked(e)},
clicked:function(e){var m=UYeefWB
var it=m.items[e.id]
...
updateDropdownsTimeLagged:function(){this.timeout=window.setTimeout('UYeefWB.updateDropdowns()',300)},
...
if(!bw)bw=0
left+=bw}}return left},
dummy:null};UYeefWB.dropdown=function(m, itPar, index, level){var f=this
...
f.level=level
f.div.obj=f
f.obj='UYeefWB.fo'+index
eval(f.obj+'=f')};UYeefWB.dropdown.prototype={showDropdown:function(){var f=this
var it=f.itPar
var fo=f.div
